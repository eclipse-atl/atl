...
public class AtlIndenter {
	 ...
	 * @param scanner the {@link AtlHeuristicScanner} to be used for scanning
	 ...
	 *         should be indented, or {@link AtlHeuristicScanner#NOT_FOUND}
	 */
	 ...
	 * otherwise <code>fAlign</code> is set to <code>AtlHeuristicScanner.NOT_FOUND</code>.
	 * 
	 * @param offset the offset for which the reference is computed
	...
	public int findReferencePosition(int offset, int nextToken) {
		...
		if (offset < fDocument.getLength()) {
			try {
				...
				boolean bracelessBlockStart= fScanner.isBracelessBlockStart(prevPos, AtlHeuristicScanner.UNBOUND);
	...
	private int prefArrayIndent() {
		...
		//		if (plugin != null) {
		//			String option= AtlCore.getOption(DefaultCodeFormatterConstants.FORMATTER_ALIGNMENT_FOR_EXPRESSIONS_IN_ARRAY_INITIALIZER);
		//			try {
	...
	private int prefCaseBlockIndent() {
		...
		//		Plugin plugin= AtlCore.getPlugin();
		//		if (plugin != null) {
		//			if (DefaultCodeFormatterConstants.TRUE.equals(AtlCore.getOption(DefaultCodeFormatterConstants.FORMATTER_INDENT_SWITCHSTATEMENTS_COMPARE_TO_CASES)))
		//				return prefBlockIndent();
		//			else
		//				return 0;
		//		}
	...
	private int prefCaseIndent() {
		...
		//		Plugin plugin= AtlCore.getPlugin();
		//		if (plugin != null) {
		//			if (DefaultCodeFormatterConstants.TRUE.equals(AtlCore.getOption(DefaultCodeFormatterConstants.FORMATTER_INDENT_SWITCHSTATEMENTS_COMPARE_TO_SWITCH)))
		//				return prefBlockIndent();
		//			else
		//				return 0;
		//		}
	...
	private boolean prefIndentBracesForArrays() {
		...
		//		Plugin plugin= AtlCore.getPlugin();
		//		if (plugin != null) {
		//			String option= AtlCore.getOption(DefaultCodeFormatterConstants.FORMATTER_BRACE_POSITION_FOR_ARRAY_INITIALIZER);
	...
	private boolean prefIndentBracesForMethods() {
		...
		//		Plugin plugin= AtlCore.getPlugin();
		//		if (plugin != null) {
		//			String option= AtlCore.getOption(DefaultCodeFormatterConstants.FORMATTER_BRACE_POSITION_FOR_METHOD_DECLARATION);
		//			return option.equals(DefaultCodeFormatterConstants.NEXT_LINE_SHIFTED);
		//		}
		return false; // sensible default
	}
	...
	private boolean prefMethodCallDeepIndent() {
		...
		//		Plugin plugin= AtlCore.getPlugin();
		//		if (plugin != null) {
		//			String option= AtlCore.getOption(DefaultCodeFormatterConstants.FORMATTER_ALIGNMENT_FOR_ARGUMENTS_IN_METHOD_INVOCATION);
		//			try {
		//				return DefaultCodeFormatterConstants.getIndentStyle(option) == DefaultCodeFormatterConstants.INDENT_ON_COLUMN;
		//			} catch (IllegalArgumentException e) {
		//				// ignore and return default
	...
	private boolean prefMethodDeclDeepIndent() {
		...
		//		Plugin plugin= AtlCore.getPlugin();
		//		if (plugin != null) {
		//			String option= AtlCore.getOption(DefaultCodeFormatterConstants.FORMATTER_ALIGNMENT_FOR_PARAMETERS_IN_METHOD_DECLARATION);
		//			try {
		//				return DefaultCodeFormatterConstants.getIndentStyle(option) == DefaultCodeFormatterConstants.INDENT_ON_COLUMN;
		//			} catch (IllegalArgumentException e) {
		//				// ignore and return default
	...
	private boolean prefTernaryDeepAlign() {
		...
		//		Plugin plugin= AtlCore.getPlugin();
		//		if (plugin != null) {
		//			String option= AtlCore.getOption(DefaultCodeFormatterConstants.FORMATTER_ALIGNMENT_FOR_CONDITIONAL_EXPRESSION);
		//			try {
		//				return DefaultCodeFormatterConstants.getIndentStyle(option) == DefaultCodeFormatterConstants.INDENT_ON_COLUMN;
		//			} catch (IllegalArgumentException e) {
		//				// ignore and return default
	 ...
	 * first Atl token after <code>scopeIntroducerOffset</code>, but before
	 * <code>bound</code>.
	 * 
