...
public class AtlPreferenceConstants {
	...
	public static final String __BOLD_SUFFIX = ".Bold"; //$NON-NLS-1$
	public static final String __COLOR_SUFFIX = ".Color"; //$NON-NLS-1$
	public static final String __ITALIC_SUFFIX = ".Italic"; //$NON-NLS-1$
	public static final String __PREFIX = "Atl"; //$NON-NLS-1$
	
	public static final String APPEARANCE = __PREFIX + ".Appearance"; //$NON-NLS-1$
	...
	public static final String APPEARANCE_HIGHLIGHT_MATCHING_BRACKETS = APPEARANCE + "HighlightMatchingBrackets"; //$NON-NLS-1$
	...
	public static final String CODEASSIST = __PREFIX + ".CodeAssist"; //$NON-NLS-1$
	...
	public static final String EDITOR = __PREFIX + ".Editor"; //$NON-NLS-1$
	...
	public static final String HOVER = __PREFIX + ".Hover"; //$NON-NLS-1$
	public static final String HOVER_ANNOTATION_ROLL_OVER = HOVER + ".AnnotationRollOver"; //$NON-NLS-1$
	
	public static final String SYNTAX = __PREFIX + ".Syntax"; //$NON-NLS-1$
	...
	public static final String TYPING = __PREFIX + ".Typing"; //$NON-NLS-1$
