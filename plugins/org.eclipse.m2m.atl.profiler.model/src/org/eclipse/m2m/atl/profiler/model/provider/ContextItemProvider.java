...
/**
 * This is the item provider adapter for a {@link org.eclipse.m2m.atl.profiler.model.Context} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContextItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Context_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Context_content_feature", "_UI_Context_type"),
				 ModelPackage.Literals.CONTEXT__CONTENT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Context)object).getContent();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Context.class)) {
			case ModelPackage.CONTEXT__CONTENT:
