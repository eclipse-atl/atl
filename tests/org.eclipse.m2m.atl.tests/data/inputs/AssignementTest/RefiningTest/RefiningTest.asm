...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="12:27-12:37"/>
		<constant value="12:4-12:37"/>
		<constant value="link"/>
		<constant value="__matchWorking"/>
		<constant value="J.not():J"/>
		<constant value="41"/>
		<constant value="18:30-18:36"/>
		<constant value="18:30-18:45"/>
		<constant value="18:26-18:45"/>
		<constant value="20:3-23:4"/>
		<constant value="__applyWorking"/>
		<constant value="21:13-21:25"/>
		<constant value="21:4-21:25"/>
		<constant value="22:28-22:38"/>
	...
	<operation name="113">
		...
		<linenumbertable>
			...
			<lne id="127" begin="7" end="8"/>
			<lne id="128" begin="23" end="37"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="1" name="121" begin="6" end="39"/>
	...
	<operation name="129">
		...
		<linenumbertable>
			<lne id="135" begin="12" end="15"/>
			<lne id="136" begin="9" end="18"/>
			<lne id="137" begin="22" end="24"/>
			<lne id="138" begin="19" end="27"/>
			<lne id="128" begin="8" end="28"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="123" begin="7" end="28"/>
			<lve slot="2" name="121" begin="3" end="28"/>
			<lve slot="0" name="26" begin="0" end="28"/>
			<lve slot="1" name="139" begin="0" end="28"/>
		</localvariabletable>
	</operation>
	<operation name="140">
		<context type="7"/>
		...
		<linenumbertable>
			...
			<lne id="145" begin="7" end="9"/>
			<lne id="146" begin="24" end="38"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="1" name="121" begin="6" end="40"/>
	...
	<operation name="147">
		...
		<linenumbertable>
			<lne id="148" begin="12" end="15"/>
			<lne id="149" begin="9" end="18"/>
			<lne id="150" begin="22" end="24"/>
			<lne id="151" begin="19" end="27"/>
			<lne id="146" begin="8" end="28"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="123" begin="7" end="28"/>
			<lve slot="2" name="121" begin="3" end="28"/>
