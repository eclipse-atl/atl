...
<asm version="1.0" name="0">
	<cp>
		<constant value="RemoveClass2010"/>
		...
		<constant value="A.__matchRemoveClass():V"/>
		<constant value="__exec__"/>
		<constant value="RemoveClass"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applyRemoveClass(NTransientLink;):V"/>
		...
		<constant value="__matchRemoveClass"/>
		...
		<constant value="__applyRemoveClass"/>
