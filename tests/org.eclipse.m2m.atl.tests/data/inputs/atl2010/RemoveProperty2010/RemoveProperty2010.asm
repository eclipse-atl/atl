...
<asm version="1.0" name="0">
	<cp>
		<constant value="RemoveProperty2010"/>
		...
		<constant value="A.__matchRemoveProperty():V"/>
		<constant value="__exec__"/>
		<constant value="RemoveProperty"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applyRemoveProperty(NTransientLink;):V"/>
		...
		<constant value="__matchRemoveProperty"/>
		...
		<constant value="__applyRemoveProperty"/>
	...
	<operation name="122">
		...
		<localvariabletable>
			<lve slot="2" name="118" begin="3" end="3"/>
			<lve slot="0" name="26" begin="0" end="3"/>
			<lve slot="1" name="125" begin="0" end="3"/>
		</localvariabletable>
	</operation>
</asm>
