 ...
 * @generated
 */
public class PojoSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PojoPackage.POJO_A: {
				PojoA pojoA = (PojoA)theEObject;
				T result = casePojoA(pojoA);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PojoPackage.POJO_B: {
				PojoB pojoB = (PojoB)theEObject;
				T result = casePojoB(pojoB);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T casePojoA(PojoA object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePojoB(PojoB object) {
		return null;
	}
