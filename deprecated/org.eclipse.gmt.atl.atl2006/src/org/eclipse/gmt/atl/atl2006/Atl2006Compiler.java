 ...
 *
 */
public class Atl2006Compiler extends AtlCompiler {
	
	private URL ATLWFRurl = Atl2006Compiler.class.getResource("resources/ATL-WFR.asm");
	...
	public EObject[] compile(InputStream in, IFile out) {
		...
		if(nbErrors == 0) {
			// Generating code
			URL atlsaurl = Atl2006Compiler.class.getResource("resources/ATLToASMCompiler.asm");
