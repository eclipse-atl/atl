...
mvn deploy:deploy-file -DrepositoryId=andromda-repository -Durl=scp://galaxy.andromda.org/var/www/andromda/maven2 -Dfile=lib/ebnfextractor.jar -DgroupId=org.atl.eclipse.engine -DartifactId=ebnfextractor -Dversion=1.13 -Dpackaging=jar -DgeneratePom=true
