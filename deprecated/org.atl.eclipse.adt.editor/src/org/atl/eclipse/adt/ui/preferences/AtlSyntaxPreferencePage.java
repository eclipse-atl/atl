...
public class AtlSyntaxPreferencePage extends AbstractPreferencePage {
	...
	/* (non-Javadoc)
	 * @see org.atl.eclipse.adt.ui.preferences.AbstractPreferencePage#handleColorListSelection()
	 */
	...
	/* (non-Javadoc)
	 * @see org.atl.eclipse.adt.ui.preferences.AbstractPreferencePage#initialize()
	 */
